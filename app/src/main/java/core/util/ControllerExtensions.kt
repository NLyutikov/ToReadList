package ru.appkode.base.core.util
...
import ru.appkode.base.core.model.SCREEN_KEY_ARG_NAME
import ru.appkode.base.core.model.ScreenKey
import ru.appkode.base.core.routing.transition.SharedElementTransition
...
fun Controller.obtainSharedTransaction(transition: SharedElementTransition): RouterTransaction {
    return RouterTransaction
        .with(this)
